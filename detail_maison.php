...
//Requette pour afficher le nombre des maisons disponibles
	...
	if (isset($_GET['idB']) AND isset($_GET['numM']) AND isset($_GET['photo']) AND isset($_GET['idM'])) {
		$idB = $_GET['idB'];
		$numM = $_GET['numM'];
		$idM = $_GET['idM'];
		$photo = $_GET['photo'];
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class="">
	  <a href="maisonsLoc.php"  style="padding-right:0"><span class="btn btn-medium btn-info">Accueil</span></a>
		  ...
		  <div class="modal-body">
			<form class="form-vertical loginFrm" method="POST" action="" >
			  <div class="control-group">	
				...
				<input type="text" id="inputEmail" placeholder="" value="<?php echo date('Y-m-d'); ?>" disabled >
			  </div>
			  <div class="control-group">	
			  	<label>Locataire</label>							
				<input type="text" id="inputEmail" placeholder="" value="<?php $d = $_SESSION['nomLoc']; echo $d; ?>" disabled>
			  </div>
			  <div class="control-group">	
			  	<label>Bailleur</label>								
				<input type="text" id="inputEmail" placeholder="" value="<?php $d = $_SESSION['nomLoc']; echo $nom; ?>" disabled>
			  </div>
			  <div class="control-group">
			  	<label>Nombre des mois</label>									
				<input type="number" id="inputEmail" placeholder="Nombre de mois" " name="nbMois">
			  </div>

			  <input type="submit" class="btn btn-success" value="Valider" name="validerDem">
...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="maisonsLoc.php">Maisons</a> <span class="divider">/</span></li>
	...
	?>  </div>
			...
			<div class="span5">
				...
				<form class="form-horizontal qtyFrm pull-center" method="POST" action="">
				  <div class="control-group">
					<label class="control-label"><h3>Prix : $<?php echo $res['Prix']; ?></h3></label><a href="#login" role="button" name="btnValid" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-inverse pull-right">Valider la réservation</span></a>
				...
				<a class="btn btn-small pull-right" href="maisonsLoc.php">Continuer la réservation</a>
				<br class="clr"/>
